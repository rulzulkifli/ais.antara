...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-8">
        <h2><small>GL</small><br>Daftar Jurnal Penyesuaian</h2>
    </div>
    <div class="col-lg-4 b-r-sm m-t-lg">
        <a class="btn btn-primary dim pull-right" href="/GL/Transaksi/jurnal_penyesuaian"><i class="fa fa-plus m-r-sm"></i>Buat Jurnal Penyesuaian</a>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="tabs-container">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li><a class="nav-link active" data-toggle="tab" href="#tab-1">Jurnal Penyesuaian</a></li>
                    <li><a class="nav-link" href="<?=BASE_URL?>/keuangan/daftar_jurnal_eliminasi">Eliminasi</a></li>
        ...
        $('.dt-jurnal').DataTable({
            ...
            "ajax": {
               // contentType: 'application/json; charset=utf-8',
                ...
                data:{jenis:"ADJS", kode_jurnal:"", keterangan:""}
            },
