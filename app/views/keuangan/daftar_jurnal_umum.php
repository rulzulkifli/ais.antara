...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-8">
        <h2><small>GL</small><br>Daftar Jurnal Umum</h2>
    </div>
    <div class="col-lg-4 b-r-sm m-t-lg">
        <a class="btn btn-primary dim pull-right" href="<?=BASE_URL?>/keuangan/tambah_jurnal_umum"><i class="fa fa-plus m-r-sm"></i>Buat Jurnal Umum</a>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="tabs-container">
                <ul class="nav nav-tabs" role="tablist">
                    <li><a class="nav-link active" data-toggle="tab" href="#tab-1">Jurnal Umum</a></li>
        ...
        $('.dt-jurnal').DataTable({
            ...
            "ajax": {
               // contentType: 'application/json; charset=utf-8',
                ...
                data:{jenis:"JRNL", kode_jurnal:"", keterangan:""}
            },
